       ...
       <div class="sidebar__widget-wrapper">
            <ul class="sidebar__category-list">
                    ...
                    if($terms) {
                        ...
                        <?php } ?>
                            <a class="btn-line sidebar__link" href="<?php echo get_category_link($term->term_id);?>"><?php echo $term->name;?></a>
                        </li>
                        ...
                        <?php } ?>
                            <a class="btn-line sidebar__link" href="<?php echo get_category_link($children_term->term_id);?>"><?php echo $children_term->name; ?></a>
                        </li>
                            <?php } } } } ?>
                </ul>
                            </div>
